...
# Load the model
pipe = pickle.load(open(r'C:\Users\harsh\Desktop\Cricket Score Predictor\pipe.pkl', 'rb'))
...
def index():
    ...
    if request.method == 'POST':
        ...
        last_six = int(request.form['last_six'])
        ...
        input_df = pd.DataFrame(
            {'batting_team': [batting_team], 'bowling_team': [bowling_team], 'city': [city], 
             ...
             'wicket_left': [wickets], 'current_run_rate': [crr], 'last_six': [last_six]}
        )
